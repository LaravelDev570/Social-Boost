...
<head>
    ...
    <title>@yield('title', 'User Dashboard - AccountForge')</title>
    ...
    <div class="d-flex">
        ...
        <div class="sidebar col-auto col-md-3 col-lg-2 px-sm-2 px-0 d-flex flex-column">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-4 text-white min-vh-100 w-100">
                <a href="{{ url('/') }}" class="d-flex align-items-center pb-3 mb-4 w-100 text-white text-decoration-none border-bottom border-secondary">
                    ...
                    <i class="bi bi-person-badge fs-4 d-sm-none text-primary"></i>
                </a>
                
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start w-100" id="menu">
                    <li class="nav-item w-100">
                        <a href="{{ route('user.dashboard') }}" class="sidebar-link active">
                            <i class="bi bi-grid-1x2 me-2"></i> <span class="d-none d-sm-inline">Dashboard</span>
                        </a>
                    </li>
                    <li class="nav-item w-100">
                        <a href="#" class="sidebar-link text-info">
                            <i class="bi bi-plus-circle me-2"></i> <span class="d-none d-sm-inline">New Request</span>
                        </a>
                    </li>
                    <li class="nav-item w-100">
                        <a href="#" class="sidebar-link">
                            <i class="bi bi-list-task me-2"></i> <span class="d-none d-sm-inline">My Requests</span>
                        </a>
                    </li>
                    <li class="nav-item w-100">
                        <a href="#" class="sidebar-link">
                    ...
                    <li class="nav-item w-100">
                        <a href="#" class="sidebar-link">
                            <i class="bi bi-bell me-2"></i> <span class="d-none d-sm-inline">Notifications</span>
                        </a>
                    </li>
                    <li class="nav-item w-100">
                        <a href="#" class="sidebar-link">
                            <i class="bi bi-person me-2"></i> <span class="d-none d-sm-inline">Profile</span>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div class="col d-flex flex-column main-content">
            ...
            <header class="topbar p-3 d-flex justify-content-between align-items-center sticky-top">
                <div>
                    <h5 class="mb-0 fw-bold font-outfit">@yield('page_title', 'Client Dashboard')</h5>
                </div>
                <div class="dropdown">
                    <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name) }}&background=60a5fa&color=fff" alt="user" width="35" height="35" class="rounded-circle me-2">
            ...
            <footer class="p-3 text-center text-muted small border-top border-secondary mt-auto">
                &copy; {{ date('Y') }} AccountForge. All rights reserved.
            </footer>
        </div>
    </div>
